      ...
      <div className="max-w-6xl px-8 mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
          {ACADEMICS.map((academic, index) => (
            <div 
              key={index}
              className="p-8 text-gray-900 transition-all duration-300 bg-white border-t-4 shadow-xl rounded-3xl hover:shadow-2xl hover:-translate-y-2 border-gradient-to-r from-blue-500 to-blue-600"
            >
              <div className="flex items-start space-x-4">
                <div className="flex items-center justify-center w-16 h-16 shrink-0 bg-linear-to-r from-blue-500 to-blue-600 rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-bold text-blue-600">{academic.result}</p>
                </div>
              </div>
            </div>
          ))}
