      ...
      <div className="max-w-6xl px-8 mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {PROJECTS.map((project) => (
            ...
            >
              <div className="relative flex items-center justify-center h-64 overflow-hidden bg-linear-to-br from-blue-500">
                <img 
                  src={project.image} 
                  alt={project.title}
                  className="object-contain w-full h-full transition-transform duration-300 group-hover:scale-110"
                />
                <div className="absolute inset-0 transition-opacity duration-300 bg-linear-to-r from-blue-500 group-hover:opacity-20 opacity-50" />
              </div>
              <div className="p-8">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech) => (
                    <span 
                      key={tech}
                      className="flex items-center gap-1.5 px-3 py-1 text-sm text-white rounded-full bg-linear-to-r from-blue-500"
                    >
                      {getTechIcon(tech)}
                      <span>{tech}</span>
                    </span>
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="flex items-center px-4 py-2 space-x-2 text-blue-400 transition-all duration-300 border border-blue-500 rounded-full hover:bg-blue-500 hover:text-white"
                  >
