export const SKILLS = [
  ...
  { icon: 'fa-brands fa-css3', name: 'Tailwindcss' },
...
export const ACADEMICS = [
  {
    ...
    institute: 'GL Bajaj college of technology and management',
    year: '2024 – 2026',
    result: 'Pursuing'
  },
  {
    icon: 'fas fa-university',
    title: 'BCA-Bachelor of Computer and Application',
    institute: 'IIMT University',
    year: '2021 – 2024',
    result: 'CGPA: 7.73/10'
  },
  {
    icon: 'fas fa-school',
    title: 'Intermediate(PCM)-CBSE BOARD',
    institute: 'Delhi Global School',
    year: '2020 – 2021',
    result: 'Percentage: 92%'
  },
  {
    icon: 'fas fa-school',
    title: 'High School-CBSE BOARD',
    institute: 'Delhi Global School',
    year: '2018 – 2019',
...
export const CERTIFICATIONS = [

  {
    ...
    title: 'Data Structure and Algorithms Design',
    issuer: 'NPTEL',
    date: 'October 2025',
...
export const PROJECTS = [
  {
    title: 'Voting Sytem using Face Recognition',
...
export const CONTACT_INFO = {
  ...
  github: 'https://github.com/umangkumar0106',
  linkedin: 'https://www.linkedin.com/in/umangkumar0106/',
  leetcode: 'https://leetcode.com/u/uk9634129129/',
  instagram: 'https://www.instagram.com/umang_kr_0106/?hl=en'
};
